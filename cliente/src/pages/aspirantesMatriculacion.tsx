...
export default function AspirantesMatriculacion() {
      ...
      <main className="p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 text-center">
            <h2 className="text-white text-3xl font-bold mb-4">Aspirantes - Matriculación</h2>
            <p className="text-white/80 text-lg">Gestión de aspirantes para matriculación</p>
          </div>
            ...
            <div className="p-12 text-center">
              ...
              <div className="max-w-2xl mx-auto mb-8">
                <p className="text-gray-600 text-lg mb-4">
                  La sección de <strong>Aspirantes - Matriculación</strong> está actualmente en proceso de desarrollo.
                </p>
                <p className="text-gray-500 text-base">
                  Nuestro equipo está trabajando para implementar todas las funcionalidades necesarias para la gestión
                  de aspirantes en el proceso de matriculación.
                </p>
              </div>
